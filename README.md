...
4. **精筛** (瞬时): 标签制精筛 — 统一通道, 基础标签全部满足(持币≥30/进度≥15%或流动性≥$10k/仿盘≥5/未崩盘/社交≥1/有动能) + 加分项至少1个(Boost/仿盘≥100/持币增长≥20/社交≥3/已毕业强势/进度增长≥10%/加速增长/首轮强势)
...
交易策略：
- 止盈：阶梯式回撤止盈（涨15%触发，15%~30%固定回撤15%，30%~300%三分点止盈法，≥300%中点止盈法）
- 止损：-30%（兜底止损）/ -25%（动能恶化时提前止损）
