...
| K线筛 | 历史最高价≤$0.00004、前2h最高价≤$0.000023(币龄>1h)、当前价在最高价40%~90%、现价比底价高10%~100%(币龄>1h,排除首根K线) | DexScreener (主) + GeckoTerminal (备) | 每候选 1~3 请求 |
...
4. **底价检查**（币龄>1h）：当前价比底价高 10%~100%（底价 = 排除第1根1小时K线后所有K线的最低价）
...
| `FLOOR_RATIO_HIGH` | 1.0 | 现价比底价高的上限 (100%, 币龄>1h) |
